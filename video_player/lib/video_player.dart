      ...
      switch (event.eventType) {
        ...
        case VideoEventType.bufferingUpdate:
          if (event.buffered!.length > 0 && _isIOSLive == true) {
            ...
            print(
                "duration:${value.duration} position:${value.position} elapsed:${stopwatch!.elapsed} end:${event.buffered![0].end} initDuration:${initDuration} start:${event.buffered![0].start} systime:${now.hour}:${now.minute}:${now.second}");
          } else {
