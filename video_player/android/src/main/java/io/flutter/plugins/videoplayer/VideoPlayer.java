...
final class VideoPlayer {
  ...
  private void setupVideoPlayer(
    ...
    Log.d("MainActivity", "setupVideoPlayer surface: " + surface);
    Log.d("MainActivity", "setupVideoPlayer surfaceTexture: " + textureEntry.surfaceTexture());
    exoPlayer.setVideoSurface(surface);
    setAudioAttributes(exoPlayer, true);

    // SimpleExoPlayerからExoPlayerに移行する
